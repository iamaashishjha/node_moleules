...
const CategoryManager_js_1 = __importDefault(require("../managers/CategoryManager.js"));
class Category extends moleculer_1.Service {
    constructor(broker) {
        super(broker);
        this.broker = broker;
        this.manager = new CategoryManager_js_1.default();
